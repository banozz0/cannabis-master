...
| Field | Question |
|---|---|
| `end_objective` | "What's the end goal — personal supply, learning, seed-making/breeding practice, preservation, or another lawful home-grow goal?" |
...
| Large lawful home setup | See `20-commercial-ops.md` for operations hygiene and safe scaling boundaries |
...
| Greenhouse / large home setup | HPS supplement (cheap CAPEX) | LED bar arrays | Quality horticultural bar fixtures |
...
| Large lawful home setup | Coco/rockwool with drip, or amended living-soil beds |
...
| Inline fan + carbon filter | AC Infinity T4/T6 + matching filter | AC Infinity S6/T8 | High-quality appropriately sized filter |
...
- Clean-stock sourcing or specialist tissue-culture support if preservation/breeding goals justify it
...
- Rules:
  ...
  - `SKILL.md` Rule 6 — preview required for initial or durable state writes; later low-risk updates summarized at session end
