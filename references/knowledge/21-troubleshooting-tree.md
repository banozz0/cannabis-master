...
- Workflow files → `references/workflows/*`
...
- Punja, Z. K. et al. (2019) — *Frontiers in Plant Science* — pathogen review at commercial scale
...
- Workflows for full diagnostic flow → `references/workflows/diagnose-from-photo.md`, `references/workflows/troubleshoot-grow.md`
