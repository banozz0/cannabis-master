...
|---|---|
| Yellowing, color changes, pattern issues | `references/knowledge/07-deficiencies.md` |
| Spots, fuzz, mildew, rot | `references/knowledge/09-disease.md` |
| Pests visible, webbing, eggs, damage holes | `references/knowledge/08-pests.md` |
| Wilting/drooping with no color change | `references/knowledge/04-medium-*.md` (watering issue) |
| Burnt tips, clawing, dark green | `references/knowledge/06-nutrients-*.md` (toxicity) |
| Heat/light stress (taco, bleach, foxtail) | `references/knowledge/02-environment.md` + `03-lighting.md` |

Cross-reference against `references/state/grow-context.md`:
- Recent feed changes?
...
- Knowledge:
  - `references/knowledge/07-deficiencies.md` — color/pattern symptoms
  - `references/knowledge/08-pests.md` — pest patterns
  - `references/knowledge/09-disease.md` — disease patterns
  - `references/knowledge/02-environment.md`, `03-lighting.md` — heat/light stress
  - `references/knowledge/04-medium-*.md` — medium-specific watering symptoms
  - `references/knowledge/06-nutrients-synthetic.md`, `06-nutrients-organic.md` — nutrient toxicity
  - `references/knowledge/21-troubleshooting-tree.md` — symptom routing branches
- Workflows:
