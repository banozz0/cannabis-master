...
**Vernacular reality:** "Indica" and "sativa" labels are loose market shorthand, not reliable taxonomy. After decades of hybridization, most modern cultivars are hybrids. For cultivation planning, use growth pattern, flowering time, morphology, and breeder/COA data rather than label vibes. See `01-genetics-strains.md`.
