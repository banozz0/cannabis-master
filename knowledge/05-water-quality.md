...
- Avoid concentrated industrial acids in home grows unless you have proper training, PPE, storage, and label/SDS guidance; common diluted horticultural pH-down is safer for most users
...
- Custom feed schedule generation → `workflows/build-feed-schedule.md`
- Setup planning incl. RO equipment selection → `workflows/new-grow-setup.md`
